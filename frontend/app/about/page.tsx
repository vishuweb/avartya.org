...
const SectionHeading = ({ children, subtitle, light = false }: { children: React.ReactNode, subtitle?: string, light?: boolean }) => (
  <div className="mb-12">
    ...
    <div className={`h-1 w-20 mt-4 rounded-full ${light ? 'bg-orange-500' : 'bg-emerald-600'}`}></div>
  </div>
);
  ...
  return (
    <main className="bg-gray-50 antialiased">
      ...
      <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center text-white overflow-hidden">
        <Image
          src="/hero.jpeg"
          alt="Community engagement in rural India"
          fill
          priority
      ...
      <section className="max-w-7xl mx-auto py-24 px-6 grid lg:grid-cols-2 gap-16 items-center">
        <div className="relative group">
          <div className="absolute -inset-4 bg-emerald-100 rounded-2xl -z-10 group-hover:scale-105 transition-transform duration-500"></div>
          <Image
            src="/about1.jpg"
            alt="Avartya team on the ground"
            width={600}
            height={450}
      ...
      <section className="bg-emerald-900 py-24 text-white">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <div>
            <SectionHeading light subtitle="The motivation behind every step we take.">
              Why We Exist
            </SectionHeading>
      ...
      <section className="max-w-7xl mx-auto py-24 px-6">
        <SectionHeading subtitle="Targeted initiatives designed for long-term community resilience.">
          What We Do
        </SectionHeading>
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              title: "Education",
              desc: "Providing resources, mentorship, and digital literacy to ensure every student has a fair shot at the future.",
              icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"
            },
            {
              title: "Health Awareness",
              desc: "Demystifying preventive healthcare and organizing community-led medical camps to save lives.",
              icon: "M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"
            },
            {
              title: "Women Empowerment",
              desc: "Fostering economic independence and leadership by creating safe spaces for skill-building and entrepreneurship.",
      ...
      <section className="bg-gray-100 py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <SectionHeading subtitle="Our systematic approach ensures that every donation and hour spent results in real impact.">
            How We Work
          </SectionHeading>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          {/* Vishal Profile */}
          <div className="flex flex-col md:flex-row gap-8 bg-white p-8 rounded-3xl shadow-sm border border-gray-100 items-start">
            <div className="relative w-32 h-32 md:w-48 md:h-48 shrink-0">
              <Image
                src="/vishal.jpeg"
                alt="Vishal Kannaujiya"
                fill
                className="rounded-2xl object-cover shadow-lg"
              />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-900">Vishal Kannaujiya</h3>
              <p className="text-emerald-600 font-bold mb-4">Managing Trustee</p>
              <p className="text-gray-600 text-sm leading-relaxed mb-4">
                A student of Mathematics & Computing at IIT Dhanbad, Vishal’s journey began in a modest home where every educational milestone was a hard-won victory.
              </p>
              <p className="text-gray-600 text-sm leading-relaxed">
                Having faced the weight of limited resources firsthand, he founded Avartya not out of charity, but out of a deep responsibility to ensure that other young minds don’t have to struggle alone to realize their dreams.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 bg-white p-8 rounded-3xl shadow-sm border border-gray-100 items-start">
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-900">Suyash Shukla</h3>
              <p className="text-emerald-600 font-bold mb-4">Operations & Ground Coordination</p>
              <p className="text-gray-600 text-sm leading-relaxed mb-4">
                Suyash is the backbone of Avartya&apos;s field execution. He believes that plans are only as good as their implementation.
              </p>
              <p className="text-gray-600 text-sm leading-relaxed">
                From navigating logistical hurdles in rural districts to building relationships with village elders, Suyash ensures that our programs are delivered with dignity and precision to those who need them most.
              </p>
            </div>
          </div>
      ...
      <section className="py-24 px-6 text-center bg-gray-900 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-64 h-64 bg-emerald-600/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <p className="text-xl text-gray-400 mb-10 leading-relaxed">
            Change doesn&apos;t require a massive gesture. It starts with a single person deciding to care. Join us as a volunteer or supporter today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-emerald-600 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-emerald-700 hover:-translate-y-1 transition-all shadow-lg shadow-emerald-900/40">
              Become a Volunteer
            </button>
            <button className="border-2 border-white/20 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-white/10 transition-all">
              Contact Us
            </button>
          </div>
        </div>
